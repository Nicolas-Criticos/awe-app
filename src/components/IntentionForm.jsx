  ...
  return (
    <form onSubmit={handleSubmit} className="w-full flex flex-col gap-10">
      ...
      <div className="flex flex-col items-center gap-6 mt-2">
        <button
          type="submit"
          className="px-8 py-3 border border-[#c2a66d]/60 text-[#c2a66d] text-xs tracking-[0.2em] uppercase hover:border-[#c2a66d] hover:text-[#c2a66d] transition-all duration-300 cursor-pointer"
          style={{ fontFamily: "Inter, sans-serif" }}
        >
          I am ready
        </button>
